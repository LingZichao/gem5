...
work_dir="/work/uacc/hw/openroad/work_full"
...
run_design() {
    local design="$1"
    local rtl_dir="/uacc_hls/uacc_${design}/solution1/syn/verilog"
    local config="/work/uacc/hw/openroad/asap7/${design}/config.mk"
    local nickname="uacc_${design}"
...
echo "ASAP7 full-controller results: ${repo_root}/uacc/hw/openroad/work_full"

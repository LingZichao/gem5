...
The initial smoke test runs the Vitis HLS `uacc_cost` RTL through the
...
```sh
uacc/hw/openroad/run_asap7_full.sh allocator
uacc/hw/openroad/run_asap7_full.sh collector
```
...
```sh
uacc/hw/hls/run_width_sweep.sh

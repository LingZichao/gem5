...
readonly config="/work/uacc/hw/openroad/asap7/allocator/width_sweep.mk"
readonly work_dir="${UACC_PPA_WORK_DIR:-/work/uacc/hw/openroad/work_width_sweep}"
readonly nickname="uacc_allocator_width_sweep"
readonly archive_root="${UACC_PPA_ARCHIVE_ROOT:-/work/uacc/hw/openroad/asap7/width_sweep_results}"
...
for variant in "${variants[@]}"; do
    ...
    rtl_dir="/uacc_hls/width_variants/${variant}/uacc_allocator/solution1/syn/verilog"

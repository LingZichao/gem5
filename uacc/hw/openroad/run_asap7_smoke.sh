...
config="/work/uacc/hw/openroad/asap7/cost/config.mk"
work_dir="/work/uacc/hw/openroad/work"
rtl_dir="/uacc_hls/uacc_cost/solution1/syn/verilog"
final_gds="${work_dir}/results/asap7/uacc_cost/base/6_final.gds"
...
echo "ASAP7 smoke results: ${repo_root}/uacc/hw/openroad/work"

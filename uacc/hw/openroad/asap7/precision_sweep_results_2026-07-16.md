...
- Accuracy JSON: `uacc/hw/fixed_point_sweep_f1_f2_f4_10000.json`.
- HLS runner: `uacc/hw/hls/run_precision_sweep.sh`.
- OpenROAD runner: `uacc/hw/openroad/run_precision_sweep.sh`.
- Archived reports: `uacc/hw/openroad/asap7/precision_sweep_results/`.

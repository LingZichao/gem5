...
`util/uacc_hw/range_width_sweep_q4_10000.json`; the engineering implementation
comparison is in `util/uacc_hw/range_width_accuracy_q4_10000.json`. The runners are
`util/uacc_hw/range_precision_sweep.py`,
`util/uacc_hw/hls/run_width_sweep.sh`, and
`util/uacc_hw/openroad/run_width_sweep.sh`; archived physical reports are under

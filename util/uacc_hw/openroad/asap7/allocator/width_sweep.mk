...
export DESIGN_NICKNAME = uacc_section14_allocator_width_sweep
...
export VERILOG_FILES = $(sort $(wildcard $(UACC_WIDTH_VARIANT_ROOT)/$(UACC_WIDTH_PROFILE)/uacc_section14_allocator/solution1/syn/verilog/*.v))

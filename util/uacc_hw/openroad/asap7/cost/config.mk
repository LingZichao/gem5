...
export DESIGN_NAME = uacc_section14_cost_uacc_section14_cost
export DESIGN_NICKNAME = uacc_section14_cost

export VERILOG_FILES = $(sort $(wildcard /uacc_hls/uacc_section14_cost/solution1/syn/verilog/*.v))
export SDC_FILE = /work/util/uacc_hw/openroad/asap7/cost/constraint.sdc

...
readonly config="/work/util/uacc_hw/openroad/asap7/allocator/precision_sweep.mk"
readonly work_dir="${UACC_PPA_WORK_DIR:-/work/util/uacc_hw/openroad/work_precision_sweep}"
readonly nickname="uacc_section14_allocator_precision_sweep"
readonly archive_root="${UACC_PPA_ARCHIVE_ROOT:-/work/util/uacc_hw/openroad/asap7/precision_sweep_results}"
...
for precision in "${variants[@]}"; do
    ...
    rtl_dir="/uacc_hls/variants/${precision}/uacc_section14_allocator/solution1/syn/verilog"
...
printf 'ASAP7 precision sweep reports: %s\n' \
    'util/uacc_hw/openroad/asap7/precision_sweep_results'
